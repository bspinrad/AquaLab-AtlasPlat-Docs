...
This platform's foremost purpose, then, is to be able to submit a "job" consisting of any number of one-off measurements, and have those measurements "schedule themselves," as efficiently as possible.
